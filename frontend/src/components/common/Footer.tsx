        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ...
              with built-in audio analysis and community features.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://github.com/djthrift"
                target="_blank"
              ...
              <a
                href="https://twitter.com/djthrift"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="https://instagram.com/djthrift"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="mailto:hello@djthrift.com"
                className="text-gray-400 hover:text-white transition-colors"
              >
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 DJ Thrift. All rights reserved.
            </p>
